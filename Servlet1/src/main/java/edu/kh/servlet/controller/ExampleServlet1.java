...
public class ExampleServlet1 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// <input name = "inputName">에 작성된 제출된 값 얻어오기
		String inputName = req.getParameter("inputName");
		
		// <input age = "inputAge">에 작성된 제출된 값 얻어오기
		 ...
		 * HTML 코드를 출력 -> 출력받은 HTML 코드를 해석해서 화면 구성
		 * 
		...
		sb.append("<body>");
		sb.append(String.format("<h1> %s 님의 나이는 %s세입니다.</h1>",inputName,inputAge));
		sb.append("</body>");
		
		sb.append("/html");
		
		// sb에 누적된 html코드를 출력시키기 
