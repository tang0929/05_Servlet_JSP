...
public class PizzaOrderServlet extends HttpServlet {
	...
	/* 요청 주소가 같아도 method가 GET/POST로 다른 경우 따로처리하는 코드를 작성 가능*/
